...
public class Employee implements Serializable {
    ...
    public Employee formData(Set<FormData> formData) {
        this.formData = formData;
        return this;
    }

    public Employee addFormData(FormData formData) {
        this.formData.add(formData);
        formData.setAuthor(this);
        return this;
    }

    public Employee removeFormData(FormData formData) {
        this.formData.remove(formData);
        formData.setAuthor(null);
        return this;
    }
