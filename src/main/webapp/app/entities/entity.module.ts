...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'form-schema',
        loadChildren: () => import('./form-schema/form-schema.module').then(m => m.JhipsterSampleApplicationFormSchemaModule)
      },
      {
        path: 'form-data',
        loadChildren: () => import('./form-data/form-data.module').then(m => m.JhipsterSampleApplicationFormDataModule)
      }
